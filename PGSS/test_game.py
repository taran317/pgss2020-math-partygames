...
print("NEW ROUND\n")
game.turn(game.players[0],[bot0.bot_turn(game)],True)
print(game)
game.turn(game.players[1],[bot1.bot_turn(game)],True)
print(game)
game.turn(game.players[2],[bot2.bot_turn(game)],False)
print(game)
game.turn(game.players[3],[bot3.bot_turn(game)],True)
print(game)
print('ROUND TWO\n')
